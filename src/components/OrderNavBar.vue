<template>
    <div class="container">
                 ...
                 <div v-if="logIn" class="search-section-2">
                     <div class="links">
                         <img class="cart" src="../images/icons8-order-64.png"/><span class="user-home-text">Orders</span>
                             ...
                             <ul class="navs">
                                 ...
                                 <router-link class="routes" to="/about">
                                     <li>
                                         <img class="cart" src="../images/icons8-about-50.png"/><span>About</span>
                                     </li>
                                 </router-link>
                             </ul>
                     </div>
