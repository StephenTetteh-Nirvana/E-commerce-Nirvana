        ...
        <div class="container-box">
                ...
                <div v-if="logIn" class="search-section-2">
                    ...
                    <div class="links">
                        ...
                        <div class="home-hover">
                            ...
                            <span class="user-home-text">Home</span>
                        </div>
         ...
         <div class="content">
            <div class="inner-content">
                <h1>Welcome To</h1>
                <h4 class="urban-2">TrendyEra</h4>
                <router-link to="products"><button>See Products</button></router-link>
            </div>
        ...
        <div class="bottom-container">
            <div class="bottom-child">
                ...
                <router-link to="/">
                    ...
                    <img class="cart-home" src="../images/red-home.png"/><br/>
                    <h5>Home</h5>
                   </button>
                </router-link>
                </div>
                ...
                <router-link to="/products">
                    ...
                    <img class="cart" src="../images/icons8-categories-64.png"/><br/>
                    <h5>Products</h5>
                </button>
                </router-link>
                </div>
                ...
                <router-link to="/contact">
                    ...
                    <img class="cart" src="../images/icons8-online-support-50.png"/><br/>
                    <h5>Help Center</h5>
                </button>
                </router-link>
                </div>
...
import {db} from '@/main.js'
   export default{
    ...
    //constant that binds cartCount with the cart length returned from the store.
  ...
  cart: []
        ...
        ////Function that displays ref values based on user authentication
...
.container-box{
    background-image:linear-gradient(rgba(0,0,0,0.75),rgba(0,0,0,0.75)),url(../images/marvin-meyer-SYTO3xs06fU-unsplash.jpg);
