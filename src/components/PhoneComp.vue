    ...
    <div class="container">
     ...
     <!-- <div  class="account">
                  <div class="account-content">
                            ...
                            <router-link to="/login"><button class="account-login">Login</button></router-link>
                            <router-link to="/register"><button class="account-register">Register</button></router-link>
                            <button @click="scroll" class="account-scroll">Keep scrolling</button>
                        </div>
                        </div> -->
                        <div class="hidden">Hello</div>
                       
   <!-- <div  class="update"><h1>Updating your cart...</h1></div>
   <div  class="update-done"><h1>Cart updated Successfully...</h1></div> -->
...
import {db} from '@/main.js'
    ...
    name: 'Hp pavilion',
                        ...
                        quantity: 1,
                        serial: 224,
                        imagePath: require('../images/laptop-white-removebg-preview.png') 
};
    ...
    name:'MacBook Pro',
                 ...
                 quantity:1,
                 serial:574,
                 imagePath: require('../images/laptop-removebg-preview.png'), 
};
    cartArray.push(newCartItem);
    ...
    const newCartItem = {
        name:'Dell Inspiron',
                 ...
                 quantity:1,
                 serial:974,
                 imagePath: require('../images/dell-three-removebg-preview.png'), 
};
    cartArray.push(newCartItem);
    ...
    name: 'MacBook Air',
                        ...
                        quantity: 1,
                        serial: 324,
                        imagePath: require('../images/laptop-new-1.png') 
};
    cartArray.push(newCartItem);
    ...
    name: 'Acer 2500',
                        ...
                        quantity: 1,
                        serial: 724,
                        imagePath: require('../images/laptop-new-2.png') 
};
    cartArray.push(newCartItem);
    ...
    name: 'Hp EliteBook',
                        ...
                        quantity: 1,
                        serial: 924,
                        imagePath: require('../images/laptop-new-3.png') 
};
    cartArray.push(newCartItem);
...
.mother-box{
   ...
   /* FIRST PRODUCT BOX */
   .first-image{
   background-image: url(../images/laptop-white-removebg-preview.png);
...
.item-added-btn{
  ...
  /* SECOND PRODUCT BOX */
  .second-image{
   background-image: url(../images/laptop-removebg-preview.png);
   background-repeat:no-repeat;
...
.btn-two:hover{
 ...
 /* THIRD PRODUCT BOX */
 .third-image{
   background-image: url(../images/dell-three-removebg-preview.png);
   background-repeat:no-repeat;
   background-size: cover;
   background-position:center;
   width:100%;
...
.fourth-image{
   background-image: url(../images/laptop-new-1.png);
   background-repeat:no-repeat;
   background-size: cover;
   background-position:center;
   border-bottom:1px solid red;
...
.fifth-image{
   background-image: url(../images/laptop-new-2.png);
   background-repeat:no-repeat;
   background-size: cover;
   background-position:center;
   border-bottom:1px solid red;
...
.sixth-image{
   background-image: url(../images/laptop-new-3.png);
   background-repeat:no-repeat;
   background-size: cover;
   background-position:center;
   border-bottom:1px solid red;
