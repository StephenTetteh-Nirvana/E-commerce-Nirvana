...
import {db} from '@/main.js'
    ...
    name: 'Jean Shorts',
                        ...
                        quantity: 1,
                        serial: 224,
                        imagePath: require('../images/women-jeans.png') 
};
    ...
    name:'Crochet Top',
                 ...
                 quantity:1,
                 serial:574,
                 imagePath: require('../images/women-top.png'), 
};
    cartArray.push(newCartItem);
    ...
    const newCartItem = {
        name:'High heels',
                 ...
                 quantity:1,
                 serial:974,
                 imagePath: require('../images/heels.png'), 
};
    cartArray.push(newCartItem);
    ...
    const newCartItem = {
        name:'Sunglasses',
                 ...
                 quantity:1,
                 serial:624,
                 imagePath: require('../images/sunglasses-new.png'), 
};
    cartArray.push(newCartItem);
    ...
    const newCartItem = {
        name:'Red Hat',
                 ...
                 quantity:1,
                 serial:604,
                 imagePath: require('../images/hat-new.png'), 
};
    cartArray.push(newCartItem);
    ...
    const newCartItem = {
        name:'Silver Necklace',
                 ...
                 quantity:1,
                 serial:444,
                 imagePath: require('../images/jewelry-new.png'), 
};
    cartArray.push(newCartItem);
...
.mother-box{
   ...
   /* FIRST PRODUCT BOX */
   .first-image{
   background-image: url(../images/women-jeans.png);
...
.btn-two:hover{
 ...
 /* THIRD PRODUCT BOX */
 .third-image{
   background-image: url(../images/heels.png);
   background-repeat:no-repeat;
...
.fourth-image{
   background-image: url(../images/sunglasses-new.png);
   background-repeat:no-repeat;
   background-size: cover;
   background-position:center;
...
.fifth-image{
   background-image: url(../images/hat-new.png);
   background-repeat:no-repeat;
   background-size: cover;
   background-position:center;
   border-bottom:1px solid red;
...
.sixth-image{
   background-image: url(../images/jewelry-new.png);
   background-repeat:no-repeat;
   background-size: cover;
   background-position:center;
   border-bottom:1px solid red;
